            ...
            <div class="row ">
                <div class="col-lg-9" dir="rtl">
                    ...
                    <div class="heading-section ftco-animate mb-5 text-center ">
                        <h2 class="mb-4">ویرایش دسته بندی ها</h2>
                    </div>
                    <form class="row contact_form" action="{{route('admin.category.update',$category->id)}}" method="POST" id="contactForm"
                        ...
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{route('admin.categorys')}}"> <div style="font-size: 18px; color:black; margin: 10px;"
