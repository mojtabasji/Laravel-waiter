        ...
        <div class="container justify-content-center">
            <div class="row ">
                <div class="col-lg-9" dir="rtl">
                    ...
                    <form class="row contact_form" action="{{route('admin.users.update',$user->id)}}" method="POST" id="contactForm"
                            ...
                            <div class="input-group-icon" dir="rtl">
                                ...
                                <div class="form-select"  dir="rtl"
                                    ...
                                    <select name="role" style="font-size: 18px;">
                                        <option value="1" <?php if($user->role == 1 ) echo 'selected'; ?>>مدیر</option>
                                        <option value="2" <?php if($user->role == 2 ) echo 'selected'; ?> >کارکنان</option>
                                    </select>
                                </div>
                                @error('role')
                                    <div class="alert alert-danger">{{ $message }} </div>
