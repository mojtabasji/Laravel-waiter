            ...
            <div class="row ">
                <div class="col-lg-9" dir="rtl">
                    ...
                    <div class="heading-section ftco-animate mb-5 text-center ">
                        <h2 class="mb-4">ویرایش عضو</h2>
                    </div>
                    <form class="row contact_form" action="{{route('admin.member.update',$member->id)}}" method="POST" id="contactForm"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$member->discount}}"
                                    style="border: 2px solid rgb(61, 63, 206); border-radius: 4px;  color: black;"
                        ...
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{route('admin.members')}}"> <div style="font-size: 18px; color:black; margin: 10px;"
