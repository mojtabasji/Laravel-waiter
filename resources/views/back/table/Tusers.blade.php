    ...
    <div class="whole-wrap" style="text-align: right">
        <div class="container">
            <div class="section-top-border"  >
                <h3 class="mb-30 title_color">میزها</h3>
                <hr>
                <div class="progress-table-wrap" dir="rtl">
                        ...
                        @foreach ($users as $user)
                            ...
                            <div class="table-row" style="color: black">
                                ...
                                <div class="percentage">
                                    ...
                                    <a href="{{route('admin.table.edit',$user->id)}}" class="genric-btn success circle">ویرایش</a>
                                </div>
                    ...
                    <div class="col-md-12 text-right">
                        <a href="{{route('admin.table.insert')}}"> <div style="font-size: 18px; background-color: rgb(30, 209, 30);color:black; margin: 10px;"
